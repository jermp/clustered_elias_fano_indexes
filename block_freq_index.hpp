...
namespace ds2i {
    ...
    public:
        ...
        public:
            ...
            void print_cluster_stat() {
                ...
                uint64_t cluster_bits =
                    m_lists.size() * 8 - m_docs_sequences_size;
                std::cout << "\tcluster bits x posting (also includes bits x freq): "
                          << double(cluster_bits) / m_cur_cluster_postings
                          << std::endl;
                m_cur_cluster_postings = 0;
                m_docs_sequences_size = m_lists.size() * 8;
            }
        ...
        private:
            ...
            uint64_t m_cur_cluster_postings;
            uint64_t m_docs_sequences_size;
